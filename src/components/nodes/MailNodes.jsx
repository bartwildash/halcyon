        ...
        <div style={{ padding: '20px 24px' }}>
          ...
          >
            <div>
              ...
              <div style={{ fontSize: 12, color: '#64748b' }}>
                From: <span style={{ fontWeight: 500, color: '#334155' }}>{data.sender}</span>
              </div>
            </div>
            <div
              style={{
          ...
          >
            ...
            {isOpen && (
              <p style={{ marginTop: 12 }}>
                We've been reviewing the spatial computing paradigms and I think the skeuomorphic
                approach to the mailbox is a winner. Let's schedule a deep dive next Tuesday to
                refine the physics interactions.
                <br />
                <br />
                Best,
                <br />
          ...
          <AnimatePresence>
            {isOpen && (
              ...
              >
                <button className="nodrag" style={actionButtonStyle}>
        ...
        >
          ...
          <div style={{ display: 'flex', gap: 12, fontSize: 11, color: '#cbd5e1' }}>
            <span style={{ display: 'flex', alignItems: 'center', gap: 4 }}>
              <Clock size={12} /> {data.readTime || '5 min'}
            </span>
            <span style={{ display: 'flex', alignItems: 'center', gap: 4 }}>
