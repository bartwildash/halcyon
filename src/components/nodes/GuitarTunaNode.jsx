...
const TUNINGS = {
  ...
  banjo: [
    ...
    { note: 'G', frequency: 392.00, string: 1 }
  ]
};
    ...
    <SwayWrapper style={{ width: 380, height: 200 }}>
      ...
      <div style={{
        ...
        <div style={{
          ...
          boxShadow: '0 8px 24px rgba(0,0,0,0.3), inset 0 -4px 8px rgba(0,0,0,0.2), inset 0 4px 8px rgba(255,255,255,0.1)',
          overflow: 'visible'
        }}>
          ...
          <div style={{
            position: 'absolute',
            inset: 0,
            background: 'repeating-linear-gradient(45deg, transparent, transparent 8px, rgba(30, 41, 59, 0.08) 8px, rgba(30, 41, 59, 0.08) 16px)',
            borderRadius: '60% 80% 80% 60% / 50% 50% 50% 50%',
            pointerEvents: 'none'
          }} />
            ...
            <>
              ...
              {closestString && (
                <div style={{
                  ...
                  color: status === 'in-tune' ? '#10b981' :
                         status === 'close' ? '#f59e0b' : '#ef4444'
                }}>
                  {closestString.note}
              ...
              <div style={{
                ...
                {closestString && (
                  <div style={{
                    ...
                    width: 4,
                    height: 14,
                    background: status === 'in-tune' ? '#10b981' :
                               status === 'close' ? '#f59e0b' : '#ef4444',
                    borderRadius: 2,
