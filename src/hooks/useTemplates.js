...
export const useTemplates = () => {
   ...
   */
  const captureWorkspace = useCallback((name, description, tags = []) => {
   ...
   */
  const createEmptyTemplate = useCallback((name, description = '') => {
    const template = {
      name,
      description,
      tags: [],
   ...
   */
  const exportTemplate = useCallback((templateId) => {
    const template = getTemplate(templateId);
   ...
   */
  const importTemplate = useCallback((jsonString) => {
    try {
